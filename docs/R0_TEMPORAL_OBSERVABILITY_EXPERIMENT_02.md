...
> minimal earlier/later comparison materially improved recoverability of specific human authorship, persistence and later enabled use.

But its result was confounded by a literal physical-access mechanism:
...
- same people;
- same viewpoint and scale;
- same restrained surrounding world;
- visible authorship in the earlier moment;
- persistence into the later moment;
- later independent use;
- no helper/rescuer/controller hierarchy;
