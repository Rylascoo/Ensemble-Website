...
## Production baseline
The original V2.2 website baseline was promoted by PR #68 merge `e5aea65a315dd9331092e75213d7825f1d2cf25a`, with social-card consistency repair `e588dc01bf2ce37bc8d65ed53b4ad06fbbf4290f`. The current approved identity successor was promoted by PR #75 merge `4a847ddd942598bba6e8e8a6febd4e9ce9f3c65d`: viewport-centered B optical spacing with the unchanged frozen Stage (`c3db042c590ad97bb44d39e9840a5d7259cd0352f2915dadb5a00df896e945c3`) and V4 social card (`900838f5ddbdd0867c7c1f6ef6d2e4349e2766ae5ca1425a73ee1d1e3c739d1b`). Production closeout is recorded in Design Ledger L-178 and `docs/evidence/WEBSITE_V2_2_VIEWPORT_CENTERED_SUCCESSOR_PRODUCTION_CLOSEOUT_01.md`.
