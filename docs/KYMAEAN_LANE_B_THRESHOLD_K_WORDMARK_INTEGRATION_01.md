...
The Director asked to reconsider the historical **Threshold K** logo candidate as a temporary visual-design element and to determine how using that mark changes the KYMÆAN wordmark design.

This does **not** select Threshold K as the final logo and does not select a final wordmark.

## Recovered Threshold K authority
...
Historical board wording: surrounding fields create a subtle K-shaped threshold only in the space between them: `Not drawn. Discovered.`

The historical exact surface remains inspiration/evidence rather than automatic current authority.
