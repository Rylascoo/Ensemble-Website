...
This is not a public tagline, not an application-product constitution, and not a frozen aesthetic.
...
- `Rylascoo/Ensemble-Project` remains product-engineering authority and is read-only for website work unless explicitly instructed otherwise.
