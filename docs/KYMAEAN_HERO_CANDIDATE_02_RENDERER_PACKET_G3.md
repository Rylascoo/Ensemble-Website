...
At least one specific person may continue across two materially different depiction states within the same artwork: for example body into altered matter, shadow, particulate, planar, organic, reflective, or another translated form. Do not use these examples literally unless they arise naturally.

The translated state must remain recognizably tied to the same person through coherent non-color cues such as silhouette, gesture, clothing structure, posture, repeated physical marks, or spatial continuity. It should read as one continuous person/world event, not a duplicated before/after portrait or split-screen transformation. Transformation must not replace the human being with an avatar or abstract emblem.

A prior human action must be recoverable from the present translated residue or changed field, and that persistent change must materially alter what another person can occupy, reach, use, avoid, perceive, or do now. The transformation exists to deepen human causality and relationship, not to become spectacle, collage, or character-design showcase.
