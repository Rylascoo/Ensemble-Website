...
Status: **DIRECTOR DESIGN CHECKPOINT — PROPOSED TWO-RENDER CONTRASTIVE TEST / NO RENDER AUTHORIZED**

Updated: 2026-09-03

## Purpose

Controlled Formal Matrix 01 established that the current renderer can preserve a human relational semantic route across materially different Director-controlled formal grammars while suppressing prior environment-first architectural/cinematic attractors.

Its repeated limitation was semantic rather than formal:

- visible present action was legible;
- different responses were legible;
- exact relational before/after remained inferential;
- `unequal understanding` remained only partially defensible because a still image cannot directly prove a private mental state from expression or posture.

This checkpoint redesigns the semantic test so that the next experiment measures **observable relational evidence** rather than inaccessible mental-state inference.

No image is authorized by this document.

## Evidence basis

### RI-007 — Deliberate Division / Partial Visibility

Strong evidence that asymmetric **access/visibility** can be visually demonstrable inside one shared reality. The transferable law is not a literal divider; it is that different positions can provide different access to one authoritative condition.

### RI-008 — Interrupted Continuity

Evidence that present interruption/correspondence can imply a former continuity without age, damage, flashback, or explicit before/after panels. Its causal history remained only partial, so interruption alone is not sufficient.
...
Attention, avoidance and orientation can organize a relational field, but they should not be scored as proof of private knowledge.

### AL-C01 / AL-D01 / AL-E01

Occlusion, void, gesture, distance, overlap and changed shared regions can carry relationship while keeping the shared world subordinate to the people.

### Controlled Formal Matrix 01

CFM-01A/B/C established that human structural importance, single-image person attribution and relational legibility survive explicit formal control. The old environment-first architecture/bridge/period/cinematic attractor family did not recur.

## Core correction: observability classes

### Class 1 — Directly observable

A still image can directly show:

- body orientation;
- contact and separation;
- overlap and occlusion;
- alignment and interruption;
- possession or physical control;
- action physically contiguous with a changed state;
- repeated organization and visible exception;
- who has unobstructed or obstructed visual access to a piece of evidence;
- who is structurally included, excluded, connected or interrupted.

These can be used as experiment gates.

### Class 2 — Recoverable historical inference
...
This is acceptable because the inference is grounded in co-present visual evidence rather than invented backstory.

### Class 3 — Private mental state

A still image cannot directly prove:
...
Expression, posture and gaze can suggest these states, but they do not independently establish them.

Therefore future still-image gates must not treat `unequal understanding` as a directly provable outcome.

## Terminology correction

For the next semantic-observability test:

> **`unequal understanding` is replaced by `unequal access to causal evidence` / `asymmetric evidentiary position`.**

This is a measurement correction, not a change to the broader Kymaean system hypothesis. The project may still care about unequal knowledge or interpretation, but a still-image experiment should only claim what its visible evidence can support.
...
Removing the people removes the experiment's structure and meaning.
...
## Why access replaces understanding

RI/AL evidence supports visibility, orientation, occlusion, attention and possession as observable asymmetry mechanisms.

It does not support the stronger claim that a still image can independently prove what a depicted person knows.

The next experiment therefore asks whether **the opportunity to know** is asymmetrical, not whether private knowledge itself can be read.

## Formal control for the next semantic test
...
- enough body information for posture/orientation to be unambiguous;
...
- a viewer can identify who has stronger visual access to the causal evidence without making a claim about either person's private knowledge.

## Exact draft packets — NOT RENDER AUTHORIZED
...
- formal grammar;
- tonal/render treatment;
- artwork-only return contract;
- no references.
...
Maximum budget: **2 images**.

One fresh regular non-project Renderer Context per image. No corrective chain.
...
No surface produced by SOV-01A/B would receive inheritance rights merely because the semantic mechanism works.

Do not infer user preference from image return alone.

Do not promote this checkpoint into R1 or production website work.
