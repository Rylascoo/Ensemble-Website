...
`main` remains the promoted authority baseline. Serial branch `design/sym01-primary-symbol-successor-2026-09-10` carries the resolved SYM-01 decision pending lifecycle closeout. `site/` alone is deployable/public. Do not mutate stale central Q-DESIGN-19 during active Engineering provider work.
...
Open a separate bounded **Threshold K exact-shape refinement** program. Preserve the exact selected C0 bytes as immutable control; refine geometry only. No CLR-01 reentry, wordmark/material/motion/state/hero coupling, production asset claim, final identity, or Phase-C convergence.
