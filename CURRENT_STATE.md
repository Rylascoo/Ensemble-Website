...
`main` remains the promoted authority baseline. `site/` alone is deployable/public. Do not mutate stale central Q-DESIGN-19 during active Engineering provider work.
...
Original C0 Threshold K is immutable reference authority. Future symbol work is divided into:
