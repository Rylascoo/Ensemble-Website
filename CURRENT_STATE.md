...
## Authority
`Rylascoo/Ensemble-Website` owns Design/UI; `Rylascoo/Ensemble-Project` owns Product/Engineering. APPUI remains isolated from concurrent Website publication work. Recover live refs and `AGENTS.md` first.

## APPUI implementation baseline
`PKT-APPUI-NATIVE-HANDOFF-01` remains READY FOR ENGINEERING CONSUMPTION. Durable shell reference is quiet Home / Productions / Settings; Product-semantic Studio / Stage / Archive map to Production-shaping/current-possibility, Live Stage, and causal/history/deep inspection rather than mandatory permanent tabs. Current references remain Light F2 / Dark D3, MAT F1, TYP F1 + Source Sans 3, STA F2, FICON F1 and invariant dark Stage/S1.
