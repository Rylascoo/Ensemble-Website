...
Approved grammars: **Bounded Chorus**, **Causal Scar**, **Posture Proximity**. Cone imagery is reserved for genuine Stage/product-truth roles. Warm causal is not generic chrome; cool never carries identity/state alone.

## Hero Candidate 01

H-A / H-B / H-C are archived. **NO CANDIDATE ADVANCES.** H-A is prop-led; H-B has strongest causality but fails hero/crop composition; H-C has strongest specificity but ambiguous prior cause + monumental-mechanism pressure. Do not refine/merge them by default.
...
Character != Performer/Portrait. Take acceptance selects what may commit; **atomic commit establishes consequence**. UI is projection, not authority. Do not generate Batch 02 yet. Proposed next gate: approve the eight laws and use **G1/G2/G3** as sterile renderer packets. Historical images stay out of renderer chats. Actor + affected person + changed evidence must fit one 4:5-safe cluster; left desktop copy zone remains quiet/expendable.
