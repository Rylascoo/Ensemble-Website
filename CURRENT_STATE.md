...
For each substantive Director turn, deliberately optimize task granularity for GPT-5.6 Sol High: choose the largest logically coupled, falsifiable scope belonging to one objective; use High reasoning for source synthesis, dependency closure, contradiction detection, falsification and recursive audit; keep simple tasks simple; stop at consequential Director/architecture/implementation/runtime/WACK/Store/external-validation gates.

---

## 2. Current cross-product design phase

The semantic interaction laboratory through CIR-T1R1 is complete enough to support true visual-identity divergence.
...
Every meaningful future design checkpoint identifies one primary workstream:
...
- `LAUNCH` — implementation-derived Store/web/promotional assets, public claims and launch consistency.
...
It may use deterministic authored interactions to teach persistent Characters, Perspective, Performance, consequence, causal history and local ownership. It does not require user Productions, provider inference, user accounts, cloud simulation state or a browser port of Ensemble merely to explain Kymaean.
...
The visual-identity phase inherits accepted semantic laws without inheriting generated surfaces. Important canonical checkpoints include:
...
- VID-01 entry + Director hypothesis map + V0R1/V0R2/V0R3 evidence.
...
### V0R1 — H1 relational carrier diagnostic

Formal result:

> **DIAGNOSTIC / TRANSFERABLE LAW ONLY — HUMAN RELATIONAL FIELD STRONG / CAUSAL RECOVERABILITY PARTIAL-FAIL / SURFACE UNSELECTED.**

Strong evidence: distinct people and relational position can organize meaning without UI or diagrams.

Failure: emotionally charged human specificity and history-like atmosphere do not establish a recoverable prior cause or materially changed present possibility.

### V0R2 — shared-condition / H4-adjacent diagnostic
...
Strong evidence: one shared condition can organize several people with visibly unequal burden, readiness, dependence and access while preserving epistemic restraint.

Failure: a current social/environmental condition does not by itself show that a prior human act changed the usable structure.

### V0R3 — H2 carrier viability
...
V0R3 visibly presents a shared interior reconfigured through human-made partitions, coverings, openings and use zones. The present now supports different movement, enclosure, work, access and occupation.
...
The image does **not** establish exact builder, owner, motive, legality, prior use, social status, family relation or private epistemic state.

H2 `Inherited Condition` therefore survives as a **carrier hypothesis**, not as a selected painterly/architectural surface.

### Three-render process finding

The Director confirms every VID render was generated in a clean, new regular renderer chat.

V0R1, V0R2 and V0R3 nevertheless independently recur toward painterly social realism, serious human observation, muted earth/blue tonal fields and worn/weathered environments.

Treat this as evidence of a renderer prior under the semantic prompts—not as three votes for a Kymaean identity.
...
Exact machine authority preserved:
...
Actual WinUI accessibility, high contrast, screen-reader behavior, runtime performance, NPU routing and Store validation remain implementation/external-validation work.
...
V0R1/V0R2/V0R3 additionally grant no inheritance rights to:

- painterly/oil-like social realism;
- muted earth/brown/blue/amber tonal worlds;
- worn domestic, transit, industrial or communal settings;
- tables/chairs/books/framed objects/plants/papers/cups;
- rainy-night shelter/transit imagery, reflective pavement, city lights;
- improvised partitions, tarpaulin, exposed plaster, laundry/fabric, sewing/water vocabulary;
- phones, briefcases, delivery packs, canes, bicycles, basins or other exact props;
- exact casts, faces, ages, clothing, poses, inferred occupations, camera, crop, lighting or brushwork.

Historical R0 resemblance does not invalidate independent rediscovery; independent rediscovery grants no incumbency.

> **Surface != law.**

---

## 11. Design continuity / Renderer Isolation

`docs/DESIGN_CONTINUITY.md` remains active law for visual lineage, Renderer Isolation, prompt-seed discipline, exploration/refinement, asset continuity, archival requirements and anti-convergence safeguards, interpreted through:
...
Do not show an isolated renderer Kymaean/Ensemble naming, prior artworks, critiques, hypothesis-map labels, historical surface blacklists or concrete style/example menus unless a controlled experiment explicitly requires it.

---

## 12. Drive continuity

Standalone raw active-discovery assets in:
...
The `Kymaean Visual Exploration Registry & Critique Ledger` remains the living visual/provenance record and must preserve classifications, Director reactions, transferable findings and surface quarantine.
...
VID-01 cannot converge merely because H2 has one surviving carrier-level result. At least two genuinely distinct visual families/carrier systems must survive evidence review before deliberate convergence; prefer more if survivors remain close in grammar.

---

## 14. Current Director / renderer gate

V0R1, V0R2 and V0R3 are complete.

H2 `Inherited Condition` has crossed its carrier-viability threshold in V0R3. Do **not** refine H2 immediately merely to obtain a clearer or more polished causal environment.

The smallest unresolved lateral question is now H3 `Transformational Continuity`:
...
Execute exactly one V0R4 artwork in a new regular non-project Renderer Context using only the sterile packet in that file.

Do not show that renderer V0R1/V0R2/V0R3, their critiques, the Director hypothesis map, Kymaean/Ensemble naming, project files, historical artwork, historical surface blacklists or concrete visual examples.

After V0R4 returns, evaluate H3 laterally against the surviving H2 carrier and H1/H4 diagnostic evidence. Do not create variants or begin shared-brand convergence.
