...
Distinct people can remain structurally and semantically primary across materially different formal grammars.

### Relationship as visual structure

Distance, orientation, overlap, negative space, interruption, occlusion, recurrence and attention can carry relational meaning.
...
Pattern/exception, interrupted correspondence and altered organization can make prior state/history recoverable without ruins, patina or flashback.

### Visible authorship / independent agency tension

Direct physical causality improves actor attribution but tends toward control/help/conflict semantics. Removing control preserves agency but weakens causal linkage.

### Independent agency != enabled agency

Self-directed action alone does not prove that a prior condition enabled it.
